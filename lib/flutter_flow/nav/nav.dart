...
GoRouter createRouter(AppStateNotifier appStateNotifier) => GoRouter(
      ...
      routes: [
        ...
        FFRoute(
          name: 'NewBudget',
          path: '/newBudget',
          builder: (context, params) => const NewBudgetWidget(),
        ),
        FFRoute(
          name: 'VerifyBudget',
          path: '/verifyBudget',
          builder: (context, params) => VerifyBudgetWidget(
        ...
        FFRoute(
          name: 'CategoryBudget',
          path: '/categoryBudget',
          builder: (context, params) => const CategoryBudgetWidget(),
        ),
        FFRoute(
          name: 'NewCategoryBudget',
          path: '/newCategoryBudget',
          builder: (context, params) => NewCategoryBudgetWidget(
            category: params.getParam(
              'category',
              ParamType.String,
            ),
        ...
        FFRoute(
          ...
          path: '/billPage',
          builder: (context, params) => params.isEmpty
              ? const NavBarPage(initialPage: 'BillPage')
              : const BillPageWidget(),
        ),
        FFRoute(
          name: 'TokenPage',
          path: '/tokenPage',
          builder: (context, params) => params.isEmpty
              ? const NavBarPage(initialPage: 'TokenPage')
              : const TokenPageWidget(),
        )
